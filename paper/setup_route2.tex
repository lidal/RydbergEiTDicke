...
\node[box, fill=Gold!12, draw=Gold!70!black, anchor=north] (out) at (7.2,-2.35)
   {\textbf{read-out:}\ \ $\delta_{\rm th}\ \Rightarrow\ E_\mu=+\dfrac{2\hbar}{d}\,\delta_{\rm th}+\text{const}$\\[1pt]{\tiny(exact once $\Omega_\mu\gg2\lambda^2/\omega$)}};
...
\draw[Gold!70!black, line width=1.2pt, dash pattern=on 3pt off 2pt]
  (0.15,2.95) .. controls (1.85,2.55) and (2.75,1.35) .. (3.75,0.05);
\draw[Gold!70!black, line width=1.2pt, dash pattern=on 3pt off 2pt] (3.75,0.05) -- (4.45,0.05);
\draw[->, Gold!70!black, line width=0.8pt] (1.80,1.55) -- (2.70,1.55);
...
\node[box, fill=Gold!12, draw=Gold!70!black, anchor=north west] at (-0.35,-0.95)
   {$\dfrac{\partial\delta_{\rm th}}{\partial E_\mu}\to+\dfrac{d}{2\hbar}=+1.135\ \mathrm{MHz/(mV\,cm^{-1})}$};
\end{scope}
