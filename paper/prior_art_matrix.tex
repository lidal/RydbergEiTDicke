...
\newcommand{\strand}[2]{%
  \multicolumn{10}{@{}l@{}}{\rule{0pt}{3.6ex}\textbf{\textcolor{Navy}{#1}}\ \ \sub{#2}}\\[2pt]}
...
{\small
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{4.7cm} ccc c >{\raggedright\arraybackslash}p{2.9cm} c c c >{\raggedright\arraybackslash}p{4.6cm}@{}}
\toprule
...
\strand{D.\ This proposal}{the one combination nobody occupies}
\rowcolor{Ours} \textbf{Critical Dicke electrometry} & \yes & \yes & \yes & \yeskey & \yes\ \sub{$\mathbb{Z}_2$ Dicke} & \sub{optional} & \yeskey\,\sub{\textbf{sets} $\lambda_c$} & Th & $\lambda_c=\tfrac12\sqrt{\omega\tilde\omega_0}$ is a function of the measurand\\
\bottomrule
\end{tabular}}
...
\begin{itemize}[leftmargin=1.4em,itemsep=2pt]
  ...
  \item \textbf{Strand C} has the genuine $\mathbb{Z}_2$ Dicke transition and does no sensing. The near-miss is
...
\textbf{The empty cell that defines the project} is the intersection of the last two columns --- a
$\mathbb{Z}_2$ Dicke transition whose critical point \emph{is} the measurand:
\[
  \lambda_c=\tfrac12\sqrt{\omega\,\tilde\omega_0}\,,\qquad
  \tilde\omega_0=\delta+\Omega_\mu/2\,,\qquad
  \Omega_\mu=dE_\mu/\hbar .
\]
\end{tcolorbox}
...
{\footnotesize
\begin{multicols}{2}
\begin{itemize}[leftmargin=1.1em,itemsep=0.5pt,label={}]
